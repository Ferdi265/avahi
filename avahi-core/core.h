...
typedef struct AvahiServerConfig {
    ...
    AvahiStringList *reflect_deny_query_interfaces; /**< don't reflect queries originating from these interfaces */
    AvahiStringList *reflect_deny_reply_interfaces; /**< don't reflect replies originating from these interfaces */
